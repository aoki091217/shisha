...
@section('content')
{{ Breadcrumbs::render('situation.reply.edit', $situation->id) }}
<form action="{{ route('situation.reply.update', $situation->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
    @csrf
    @method('PATCH')
    <div class="d-flex flex-wrap">
        ...
        <div class="col-6 mb-3 ps-2">
            ...
            <div class="d-flex">
                ...
                @continue($key === 'follow' || $key === 'question' || $key === 'push')
    ...
    <div class="d-flex align-items-center justify-content-end mt-3 footer-buttons gap-2">
        <a href="{{ route('situation.reply.show', $situation->id) }}" class="btn btn-secondary">戻る</a>
