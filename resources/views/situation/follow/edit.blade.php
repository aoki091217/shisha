...
@section('content')
{{ Breadcrumbs::render('situation.follow.edit', $situation->id) }}
<form action="{{ route('situation.follow.update', $situation->id) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
    @csrf
    @method('PATCH')
        ...
        <div class="col-6 mb-3 ps-2 d-flex align-items-end">
            <label class="form-check-label mb-2">
                {{ Form::checkbox(
                    'situation[purpose]',
                    2,
                    old('situation.purpose', $situation->purpose) == 2 ? 'checked' : '',
                    [
        ...
        <div class="col-6 mb-3 ps-2 d-flex align-items-end">
            <div class="mb-2">
                {{ Form::checkbox(
                    ...
                    1,
                    old('situation.is_default', $situation->is_default) == 1 ? 'checked' : '',
                    [
                        'class' => 'form-check-input form-check-radio',
                        'id' => 'isDefault'
                    ]
    ...
    <div class="d-flex align-items-center justify-content-end mt-3 footer-buttons gap-2">
        <a href="{{ route('situation.follow.show', $situation->id) }}" class="btn btn-secondary">戻る</a>
