...
@section('content')
{{ Breadcrumbs::render('situation.follow.show', $situation->id) }}
...
<div class="d-flex align-items-center justify-content-end mt-3 footer-buttons gap-2">
    <a href="{{ route('situation.follow.index') }}" class="btn btn-secondary">戻る</a>
    <a href="{{ route('situation.follow.edit', $situation->id) }}" class="btn btn-success">編集</a>
    <button type="button" class="btn btn-danger" id="deleteButton" data-route="{{ route('situation.follow.destroy', $situation->id) }}" data-bs-toggle="modal" data-bs-target="#deleteModal">
        削除
    </button>
</div>
