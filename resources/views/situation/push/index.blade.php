...
@section('content')
{{ Breadcrumbs::render('situation.push.index') }}
<div class="text-success text-center fw-bold">{{ session('situation') }}</div>
<form action="{{ route('situation.push.index') }}" method="GET" autocomplete="off" id="form">
    @csrf
    <div id="searchForm">
        <div class="col-12 d-flex justify-content-between align-items-end gap-3">
            ...
            <div class="col btn-group">
                ...
                <a href="{{ route('situation.push.index') }}" class="col-6 btn btn-secondary">リセット</a>
            </div>
            <div class="col">
                <a href="{{ route('situation.push.create') }}" class="col-12 btn btn-primary">登録</a>
            </div>
        </div>
    </div>
    <div class="table-wrapper">
        <table class="table mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="{{ route('situation.push.show', $situation->id) }}" class="d-block w-100">
                            {{ $situation->name }}
                        </a>
                    </td>
