...
class CodeReportRequest extends FormRequest
{
    /**
    ...
    public function codeIds(): array
    {
        return array_filter(array_map(fn($v) => filter_var($v, FILTER_VALIDATE_INT), $this->input('codeIds', [])));
    }
}
