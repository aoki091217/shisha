...
class QuestionController extends Controller
{
    ...
    {
        $eventType = $this->situationService->getSituationType('question');
        ...
        return view('situation.question.index', compact('situations'));
    }
    ...
    public function create()
    {
        ...
        return view('situation.question.create', compact('shops'));
    }
    ...
    public function store(SituationRequest $request)
    {
        DB::transaction(function () use ($request) {
            ...
            $situation->fill(array_merge($request->situation, ['event_type' => 3]))->save();
        ...
        return redirect()->route('situation.question.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('situation.question.show', compact('situation'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('situation.question.edit', compact('situation', 'shops'));
    }
    ...
    public function destroy($id)
    {
        ...
        if (is_null($situation)) {
            $current = strstr(Route::currentRouteName(), '.', true);
            return redirect()->route("{$current}.question.index");
        }
