...
class FollowController extends Controller
{
    ...
    {
        $eventType = $this->situationService->getSituationType('follow');
        ...
        return view('situation.follow.index', compact('situations'));
    }
    ...
    public function create()
    {
        ...
        return view('situation.follow.create', compact('shops'));
    }
    ...
    public function store(SituationRequest $request)
    {
        DB::transaction(function () use ($request) {
            ...
            $situation->fill(array_merge($request->situation, ['event_type' => 1]))->save();
        ...
        return redirect()->route('situation.follow.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('situation.follow.show', compact('situation'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('situation.follow.edit', compact('situation', 'shops'));
    }
    ...
    public function destroy($id)
    {
        ...
        if (is_null($situation)) {
            $current = strstr(Route::currentRouteName(), '.', true);
            return redirect()->route("{$current}.follow.index");
        }
